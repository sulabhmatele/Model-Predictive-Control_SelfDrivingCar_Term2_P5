...
class FG_eval
{
  public:
    ...
    void operator()(ADvector& fg, const ADvector& vars)
    {
        ...
        // NOTE: This method is implicitly called by solver
        ...
        for (int t = 1; t < N; t++)
        {
            ...
            // Calculate the value of polynomial based on the coeff calculated
            AD<double> f0 = coeffs[0] + coeffs[1] * x0 + coeffs[2] * x0 * x0 +
                            coeffs[3] * x0 * x0 * x0;

            // Calculate the desired psi
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs)
{
    ...
    // Number of var: If the state is a 4 element vector, the actuators is a 2
    ...
    // Steering angle is mostly affected by Lf (Distance to center of gravity of car)
    ...
    // Upper and lower constraints for non actuators are set to actual values,
    // to minimize deviation from expected path.
